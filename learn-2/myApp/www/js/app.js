...
var controllers = angular.module('myApp.controllers',[]),
    factories = angular.module('myApp.factories',[]),
    services = angular.module('myApp.services',[]),
    directives = angular.module('myApp.directives', []),
    app = angular.module('myApp',['ionic','myApp.controllers', 'myApp.factories', 'myApp.services', 'myApp.directives']);
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  $urlRouterProvider.otherwise('/app/person');
});
